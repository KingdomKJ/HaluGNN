...
This repository contains the implementation of HaluGNN, a novel approach for detecting hallucinations in Large Language Models (LLMs) using Graph Neural Network.

## Overview

HaluGNN is a framework designed to identify hallucinated content generated by Large Language Models. It leverages weighted directed graphs to model the hidden states and attention maps, enabling effective detection of hallucinations.

## Features

- Graph-based representation of LLM outputs
- GNN-based hallucination detection mechanism
- Comprehensive evaluation on benchmark datasets
- Easy-to-use interface for hallucination detection
