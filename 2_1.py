...
train_file_name = f'InternalStates/LLM_Check_Hallucination_Detection-main/data/halueval/Qwen/screen/halueval_Qwen_train_data_list.pkl'
test_file_name = f'InternalStates/LLM_Check_Hallucination_Detection-main/data/halueval/Qwen/screen/halueval_Qwen_test_data_list.pkl'
# 使用with语句确保文件正确关闭
...
#train()
# 保存模型参数
torch.save(model.state_dict(), f'InternalStates/LLM_Check_Hallucination_Detection-main/model/halueval_Qwen_gnn_model.pth')

# 加载模型参数
model.load_state_dict(torch.load(f'InternalStates/LLM_Check_Hallucination_Detection-main/model/halueval_Qwen_gnn_model.pth'))
