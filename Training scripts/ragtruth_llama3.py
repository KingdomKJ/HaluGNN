...
train_file_name = f'ragtruth/llama/{args.type}/ragtruth_llama3_train_data_list.pkl'
test_file_name = f'ragtruth/llama/{args.type}/ragtruth_llama3_test_data_list.pkl'
...
torch.save(model.state_dict(), f'HaluGNN/model/ragtruth_llama3_cut_gnn_model.pth')

model.load_state_dict(torch.load(f'HaluGNN/model/ragtruth_llama3_cut_gnn_model.pth'))
